...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 Group ⚠️", url="https://t.me/friends_chat_groupz")
    ])
    try:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('♻️ This Movie Not Found my Database ♾♾♾♾♾♾♾♾♾♾♾♾♾♾ ♻️ Request to admin 👉 @Rudra0_9_1')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/friends_chat_groupz'),
            InlineKeyboardButton('☎️ CONTACT ME', url='https://t.me/Rudra0_9_1'),
            InlineKeyboardButton('💠 UPDATES 💠', url='https://t.me/friends_chat_groupz')
            ],[
            InlineKeyboardButton('♻️ Help ♻️', callback_data='help'),
            InlineKeyboardButton('🌷Join my group', url='https://t.me/friends_chat_groupz'),
            InlineKeyboardButton('♻️ About ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ ᴊᴏɪɴ ᴏᴜʀ sᴇᴄᴏɴᴅ ɢʀᴏᴜᴘ  ✅', url='https://t.me/LOVE_YOU_ALL_FRIENDS')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🌴 Bots Channel 🌴', url='https://t.me/friends_chat_groupz'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 𝙂𝙧𝙤𝙪𝙥 ⚠️", url="https://t.me/friends_chat_groupz")
    ])
